...
const modern: Style = {
  ...
  variables: {
    ...
    "--h3-size": "1.5em",
    "--h4-size": "1.25em",
    "--h1-size-fixed": "4.5rem",
    "--h2-size-fixed": "3.375rem",
    "--heading-weight": "800",
...
const classic: Style = {
  ...
  variables: {
    ...
    "--h3-size": "1.4em",
    "--h4-size": "1.2em",
    "--h1-size-fixed": "3.5rem",
    "--h2-size-fixed": "2.66rem",
    "--heading-weight": "600",
    "--heading-transform": "none",
    "--heading-letter-spacing": "normal",
...
const smooth: Style = {
  ...
  variables: {
    ...
    "--h3-size": "1.45em",
    "--h4-size": "1.2em",
    "--h1-size-fixed": "4.06rem",
    "--h2-size-fixed": "3.045rem",
    "--heading-weight": "700",
    "--heading-transform": "none",
